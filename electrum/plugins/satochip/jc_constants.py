...
SEEDKEEPER_DIC_ORIGIN = {
    ...
    0x02: "Encrypted import",
    0x03: "Generated on card",
}
SEEDKEEPER_DIC_EXPORT_RIGHTS = {
    0x00: "Export forbidden",
    0x01: "Plaintext export allowed",
    0x02: "Encrypted export only",
    0x03: "Authenticated export only",
}
SEEDKEEPER_DIC_USAGE_RIGHTS = {
    0x00: "Usage forbidden",
    0x10: "Plaintext usage allowed",
    0x20: "Encrypted usage only",
    0x30: "Authenticated usage only",
}
...
DIC_CODE_BY_ASSET = {v: k for k, v in DIC_ASSET_BY_CODE.items()}
...
class JCconstants:
    ...
    PIN_MAX_SIZE = 16
    # PIN[0] initial value...
    PIN_INIT_VALUE = [0x4D, 0x75, 0x73, 0x6C, 0x65, 0x30, 0x30]  # default pin
    ...
    SECP256K1_G = [
        0x04,  # base point, uncompressed form
        0x79,
        0xBE,
        0x66,
        0x7E,

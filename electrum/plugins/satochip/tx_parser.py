...
Serializes transactions into the format expected by the Satochip JavaCard applet.
This is card-specific serialization that differs from Electrum's transaction module.
"""
